...
<div class="admin">
        ...
        <div class="content">
            <div>
                <h1><i class="fa-regular fa-image"></i> Room Image <i class="fa-regular fa-image"></i></h1>
            </div>
            <hr>
            <div class="hangHoa">
                <table>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a onclick="return confirm('Do you want delete?')" href="delete.php?id=<?php echo $item['room_image_id'] ?>"><button class="delete">Delete</button></a>
                                </td>
                            </tr>
                        <?php
                        }
