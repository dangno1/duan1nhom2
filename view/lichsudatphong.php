            ...
            <div class="invoice-content">
                    ...
                    <table class="table table-invoice">
                        <thead>
                            <tr>
                                ...
                                <th class="text-one">TÊN PHÒNG</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="text-one"><?php echo $item['kind_of_room'] ?></span><br>
                                    <!-- <small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id sagittis arcu.</small> -->
                                </td>
                                <td class="text-right"><?php echo $item['describe'] ?></td>
                                <td class="text-center"><span><img
                                            src="../controller/kindRoom/<?php echo $item['image'] ?>" width="80%"
                ...
                <div class="invoice-price">
                    ...
                    <div class="invoice-price-right">
                        <small>TOTAL</small> <span class="f-w-600">$<?php echo $item['total_money'] ?></span>
                    </div>
                </div>
                <!-- end invoice-price -->
            </div>
